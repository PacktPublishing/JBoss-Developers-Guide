<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("form");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: WelcomeUserProcess .FillWithdrawalFormTask
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="form" type="text" class="textbox" id="form" value="${form}" />
                            		</div>
